    ...
    <div className="login-page">
      <div className="login-hero">
        ...
        <div className="auth-card">
          ...
          {config.login.show_github && <a href={`${API_BASE}/auth/github?return_url=${encodeURIComponent(window.location.origin)}`} className="btn btn-github">
          ...
          {config.login.show_cpoauth && <a href={`${API_BASE}/auth/cpoauth?return_url=${encodeURIComponent(window.location.origin)}`} className="btn btn-cpoauth">
