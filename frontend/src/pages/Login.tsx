...
export default function Login() {
  ...
  // OAuth 回跳需要当前页 origin 作为 return_url。
  // SSR 阶段无 window,先以空串占位(与首屏 HTML 一致,避免 hydration mismatch),
    ...
    <div className="login-page">
      <div className="login-hero">
        ...
        <div className="auth-card">
          ...
          {config.login.show_github && <a href={`${API_BASE}/auth/github?return_url=${encodeURIComponent(origin)}`} className="btn btn-github">
          ...
          {config.login.show_cpoauth && <a href={`${API_BASE}/auth/cpoauth?return_url=${encodeURIComponent(origin)}`} className="btn btn-cpoauth">
